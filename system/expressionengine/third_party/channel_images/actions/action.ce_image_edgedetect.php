 ...
 */
class ImageAction_ce_image_edgedetect extends ImageAction
{
	...
	public function settings($settings)
	{
		...
		return $this->EE->load->view('actions/ce_image_edgedetect', $vData, TRUE);
	}
...
/* End of file action.ce_image_edgedetect.php */
/* Location: ./system/expressionengine/third_party/channel_images/actions/action.ce_image_edgedetect.php */
